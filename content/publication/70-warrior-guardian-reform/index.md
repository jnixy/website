...
links = [{name = "Postprint", url="Warrior_Guardian_Postprint.pdf", icon = "unlock-alt", icon_pack = "fas"}, {name = "DOI", url="https://doi.org/10.1080/10439463.2026.2662950"}]
...
![Percent of officers rating each reform proposal as reasonable](figure_reform_support.png)
