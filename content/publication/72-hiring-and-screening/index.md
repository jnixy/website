...
links = [{name = "DOI", url="https://doi.org/10.1108/PIJPSM-03-2026-0065"}, {name = "Postprint", url="https://www.crimrxiv.com/pub/kugsso0n", icon = "unlock-alt", icon_pack = "fas"}]
...
![How transparent are agency hiring pages? Distribution of the Transparency Index across 730 agencies](figure_2.png)
...
![Which agencies post more hiring information online? OLS coefficients by agency type, size, and region](figure_3.png)
