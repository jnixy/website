...
US v Leon: search warrant later ruled invalid b/c it wasn't supported by PC. Yet the Court upheld the search because the officers acted in good faith. 

Massachusetts v. Sheppard: Officers had a difficult time securing a warrant because it was the weekend. They settled on a form they had previously used for controlled substances. Made some changes, got a judge to sign it at his home. Judge makes a few changes of his own. Trial judge declared the warrant invalid because it lacked particularity, but SCOTUS disagreed. 

Arizona v. Evans: During a stop, officer's computer shows an outstanding warrant (that had been quashed 17 days prior). Evidence obtained from his search was admissible, because according to the Court, "there was no basis for believing that applying the exclusionary rule in these circumstances would have a significant effect on court employees responsible for letting police know that a warrant has been quashed."
...
Illegally obtained evidence can be introduced if it was initially discovered during an unlawful search, but later obtained independently by lawful conduct that was untainted by the initial illegality. 
