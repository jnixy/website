...
```{r, echo=FALSE, fig.align='center', out.width = "85%", fig.cap = "(Source: BJS - State and Local Law Enforcement Training Academies, 2022)"}
...
```{r, echo=FALSE, fig.align='center', out.width = "75%", fig.cap = "(Source: BJS - State and Local Law Enforcement Training Academies, 2022)"}
...
- Teaching methods and curricula [vary significantly](https://bjs.ojp.gov/document/slletar22st.pdf) across jurisdictions
