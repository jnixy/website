---
title: "Chapter 1"
subtitle: "Science, Society, and Research Related to Criminal Justice and Criminology"
author: "Justin Nix"
...
# Science, Society, and Research Related to Criminal Justice and Criminology
...
.pull-left[
```{r, echo=FALSE, fig.align='center', out.width = "76%"}
knitr::include_graphics("all_politicians.png")
```
]
...
knitr::include_graphics("all_clemson_fans.png")
```
]
...
knitr::include_graphics("academic_motivations.png")
```
...
**Exploratory research** seeks to find out how people get along in certain settings, what meanings they give to their actions, and what issues concern them. The goal is to answer the question: *what's going on here?*, and to investigate social phenomena without expectations. Often, questions asked are *open-ended.* That is, researchers aren't forcing participants to respond in any pre-determined way. 
...
So here it probably wouldn't make sense to ask cops "Hey are you for or against the protests that are occurring?" I'd guess it's a little more complicated than that (and if you read Kochel's book, you'll see that is in fact the case).
...
**Sample generalizability** exists when our conclusions based on our sample of the larger population holds true for that larger population.
...
knitr::include_graphics("cheng_book.jfif")
```
<p style="text-align: center; color: gray">.small[NYU Press, authored by Tony Cheng]</p>
---
class: middle, center, inverse

```{r, echo=FALSE, fig.align='center', out.width = "56%"}
knitr::include_graphics("kahneman_quote.jfif")
```
<p style="text-align: center; color: gray">.small[h/t [@rmnth](https://twitter.com/rmnth/status/1773036347088949341)]</p>
