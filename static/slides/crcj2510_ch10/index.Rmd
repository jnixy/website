...
```{r, echo=FALSE, fig.align='center', out.width = "50%"}
knitr::include_graphics("black-box.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width = "50%"}
knitr::include_graphics("whose_orientation.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width = "50%"}
knitr::include_graphics("pop-jersey-city.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width = "50%"}
knitr::include_graphics("boot-camp.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width = "50%"}
knitr::include_graphics("the-club.png")
```
...
knitr::include_graphics("perfect-study.png")
```
