...
Science is basically just (super methodical) trial and error. 
...
A theory must also be **falsifiable**. If we can't empirically scrutinize a theory, it's not a theory at all, but a philosophy or faith-based belief. 
...
- Criminal sanctions can deter crime *generally* and *specifically*. 
  - Provided they're *swift, certain, and severe* enough. 
...
- Arrest the suspected offender.
- Warn the offender, separate them, and leave.
- "Counsel" the offender and victim, or recommend services.
...
Which do you think would reduce **recidivism**?
- Why? 

**OK, how would you test your theory?**
...
- I.E., when there is **probable cause** that a domestic assault occurred, the offender *must* be arrested. 
...
Re-examination of Milwaukee data: offenders who were married/employed were *less* likely to recidivate. Those who weren't were *more* likely to recidivate.

Now we've been around the wheel **three** times, and maybe it's more appropriate to call it a spiral at this point. 
...
3. Re-examine Milwaukee w/control theory in mind: arrest is a deterrence *if* a person is married, employed. 
...
2. Frustrated by delays

3. Fear of retribution

4. Didn't want their batterer to go to jail
