...
- But participation is voluntary, so the estimates come with a good bit of *uncertainty* due to non-reporting. 
  - In 2022 - which is the most recent data we have - 70% of agencies submitted data. 
  - **Think back to your first homework assignment**: do you trust a 70% sample? 
  - What if I told you those 70% of agencies covered 93.5% of the US population?

- What's your primary takeaway from this chart?

- Homicide rate redirected circa 2015
- Still substantially lower than its peak in the early 90s
- Some good news: Down 6% from 2022

- Not shown here:
  - All violent crime down about 1.7% YOY
  - Rape down 5%
  - Agg. assaults and robberies each down about 1%
...
knitr::include_graphics("nibrs-homicides2.png")
```
